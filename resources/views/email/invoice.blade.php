            ...
            <td>
                <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%" bgcolor="#fff" style="padding:10px 15px;font-size:14px">
                    <tbody><tr>
                        ...
                        <div style="width:50%;">
                        <div style="margin:0 auto;background: #e74c3c;padding: 10px;height: auto;">
                            
<center>                        <h3 style="margin: 0;padding: 0;color: #fff;text-transform: uppercase;letter-spacing: 2px;">Belum Lunas</h3></center>
                        </div>
        ...
        <tr>
            <td style="padding:25px 15px 10px">
                <table width="100%">
                    ...
                    <tr>
                        <td>
                            <p style="margin:0;font-size:16px;line-height:24px;color:rgba(0,0,0,0.70)">Kamu Mendapat Invoice Baru,</p>
                        </td>
                    </tr>
                </tbody></table>
            </td>
                ...
                <table width="100%" style="margin:15px 0;color:rgba(0,0,0,0.70);font-size:16px">
                    ...
                    <tbody><tr>
                        <td style="padding:15px 0 10px;color:rgba(0,0,0,0.70);font-size:14px" align="center">
                           <div style="margin-bottom:5px"><h2>Rincian</h2></div>
...
{!! !empty($transaction->first()->diskon_data) ? "<span style='background-color:#26A65B;padding:5px;color:#fff'>".$transaction->first()->diskon_data->kode."</span>" :'' !!}
    </td><td  style="border-top:1px solid rgba(0,0,0,0.12);border-bottom:1px solid rgba(0,0,0,0.12);padding:10px 0;text-align: right;"><b>{{!empty($transaction->first()->diskon_data) ? ($transaction->first()->diskon_data->jenis=='2'? $transaction->first()->diskon_data->potongan.'%':'Rp. '.number_format($transaction->first()->diskon_data->potongan,2,',','.')) : ''}}</b></td>
  </tr>
  <tr>
                ...
                <table width="100%">
                    <tbody>
                        <tr>
                            <td>
                            <center>
<img src="https://ci5.googleusercontent.com/proxy/ANXKMuH8CX9M_usb4Mhmv59kEBLublJ52uIvi7ZJoniQXDwnI4egXC_IXj4q7Z0CQ9aqoRD-ZyFT-_4c=s0-d-e1-ft#http://event.arayamedia.id/img/bca.png">
<br>
<b>Bank BCA</b>
<br>
3310421111 <br>
<br>
a/n TIYAS HENDRA SAPUTRA</center>
<br>
<br><br>
